    ...
    <Layout>
      <div className="container mx-auto px-4 py-16">
        ...
        <section className="mb-20 bg-gray-50 p-10 rounded-lg">
          <h2 className="text-3xl font-semibold text-center mb-8">Our Philosophy</h2>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-3">Culinary Craftsmanship</h3>
              <p>Each dish is carefully crafted to balance flavors, textures, and presentation, creating a memorable dining experience for all the senses.</p>
            </div>
